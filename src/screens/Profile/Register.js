          ...
          <Block flex middle>
            <Block style={styles.registerContainer}>
              <Block flex={0.25} middle style={styles.socialConnect}>
                <SocialButtons dark={true} name={i18n.t('register.signInGoogle')} onPress={() => console.log(i18n.t('register.signInGoogle'))}/>
              </Block>
              <Block flex>
                  ...
                  <KeyboardAvoidingView style={{ flex: 1 }} behavior="padding" enabled>
                    ...
                    <Block width={width * 0.8}>
                      ...
                      <Block row style={styles.passwordCheck}>
                        <Text style={styles.passwordStrength}>{i18n.t('register.passwordStrength')}</Text>
                    ...
                    <Block middle>
                      <Button color="primary" style={styles.createButton} onPress={register}>
                        <Text bold size={14} color={argonTheme.COLORS.WHITE}> {i18n.t('register.createAccount')} </Text>
                      </Button>
                    </Block>
